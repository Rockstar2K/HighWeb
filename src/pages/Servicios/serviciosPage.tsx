    ...
    <div className="min-h-screen bg-white text-gray-900 relative overflow-x-hidden mt-[15vh]">
      ...
      <div id="servicios-list" className="flex flex-col gap-0">
        ...
        <ServiceSection 
          ...
          imageContent={
            <div className="relative w-full h-full min-h-[450px] bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-2xl p-8 flex items-center justify-center group">
              <div className="absolute inset-0 bg-gradient-to-tl from-orange-500/10 to-red-500/30 opacity-100 transition-all duration-500 group-hover:from-orange-500/20 group-hover:to-red-500/40" />
              ...
              <div className="relative z-10 w-64 h-64">
                ...
                <div className="absolute -bottom-12 -left-12 -right-12 h-16 bg-white/80 backdrop-blur-md rounded-xl border border-white/50 shadow-lg flex items-center px-4 gap-2 transform transition-all duration-500 group-hover:translate-y-[-10px]">
                   ...
                   <div className="flex-1 h-2 bg-gray-200 rounded-full overflow-hidden">
                     <div className="h-full w-1/3 bg-orange-500 group-hover:w-2/3 transition-all duration-1000 ease-in-out" />
                   </div>
                   <div className="text-xs font-mono text-gray-500">00:12</div>
                </div>

                {/* Central Element */}
                <div className="absolute inset-0 bg-gradient-to-br from-orange-400 to-red-500 rounded-3xl shadow-2xl transform transition-all duration-700 group-hover:rotate-[10deg] group-hover:scale-110 flex items-center justify-center overflow-hidden">
                   ...
                   {/* Particles */}
                   <div className="absolute top-4 right-4 w-4 h-4 bg-yellow-300 rounded-full animate-pulse" />
